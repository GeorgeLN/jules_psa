        ...
        if (isEditing) {
          ...
          if (success) {
            ...
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => TabletSelectedEmojiScreen(isEditing: true, patient: widget.patient,),
              ),
            );
          } else {
          ...
          if (patientId != null) {
            ...
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => TabletSelectedEmojiScreen(isEditing: false, patientId: patientId),
              ),
            );
          } else {
            ScaffoldMessenger.of(context).showSnackBar(
