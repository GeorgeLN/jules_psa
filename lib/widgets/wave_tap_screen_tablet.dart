...
class WaveTapScreenTablet extends StatefulWidget {
  const WaveTapScreenTablet({Key? key}) : super(key: key);

  @override
  State<WaveTapScreenTablet> createState() => _WaveTapScreenTabletState();
}

class _WaveTapScreenTabletState extends State<WaveTapScreenTablet> {
  ...
  Future<void> _loadImage() async {
    final ByteData data = await rootBundle.load('assets/images/silueta_humana_tablet.png');
          ...
          child: GestureDetector(
            ...
            child: Stack(
              children: [
                Positioned.fill(
                  child: Image.asset(
                    'assets/images/silueta_humana_tablet.png',
                    key: _imageKey,
                    fit: BoxFit.contain,
                  ),
                ),
